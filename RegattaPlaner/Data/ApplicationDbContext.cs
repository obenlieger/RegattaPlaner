...
namespace RegattaPlaner.Data
{
    public class ApplicationDbContext : IdentityDbContext
    {
        ...
        public DbSet<RegattaPlaner.Models.Boatclass> Boatclasses { get; set; }

        public DbSet<RegattaPlaner.Models.Raceclass> Raceclasses { get; set; }

        public DbSet<RegattaPlaner.Models.Oldclass> Oldclasses { get; set; }

        public DbSet<RegattaPlaner.Models.Racestatus> Racestati { get; set; }

        public DbSet<RegattaPlaner.Models.Club> Clubs { get; set; }

        public DbSet<RegattaPlaner.Models.Regatta> Regattas { get; set; }

        public DbSet<RegattaPlaner.Models.Race> Races { get; set; }

        public DbSet<RegattaPlaner.Models.Member> Members { get; set; }

        public DbSet<RegattaPlaner.Models.Startboat> Startboats { get; set; }

        public DbSet<RegattaPlaner.Models.Startboatstatus> Startboatstati { get; set; }

        public DbSet<RegattaPlaner.Models.StartboatMember> StartboatMembers { get; set; }

        public DbSet<RegattaPlaner.Models.Water> Waters { get; set; }

        public DbSet<RegattaPlaner.Models.CampingFee> CampingFees { get; set; }

        public DbSet<RegattaPlaner.Models.RegattaCampingFee> RegattaCampingFees { get; set; }

        public DbSet<RegattaPlaner.Models.StartingFee> StartingFees { get; set; }

        public DbSet<RegattaPlaner.Models.RegattaOldclass> RegattaOldclasses { get; set; }

        public DbSet<RegattaPlaner.Models.Competition> Competitions { get; set; }

        public DbSet<RegattaPlaner.Models.RegattaStartingFee> RegattaStartingFees { get; set; }

        public DbSet<RegattaPlaner.Models.RegattaCompetition> RegattaCompetitions { get; set; }

        public DbSet<RegattaPlaner.Models.RaceDraw> RaceDraws { get; set; }

        public DbSet<RegattaPlaner.Models.RaceDrawRules> RaceDrawRules { get; set; }

        public DbSet<RegattaPlaner.Models.RaceTyp> RaceTyps { get; set; }

        public DbSet<RegattaPlaner.Models.ReportedRace> ReportedRaces { get; set; }

        public DbSet<RegattaPlaner.Models.ReportedStartboat> ReportedStartboats { get; set; }

        public DbSet<RegattaPlaner.Models.ReportedStartboatMember> ReportedStartboatMembers { get; set; }

        public DbSet<RegattaPlaner.Models.ReportedStartboatStandby> ReportedStartboatStandbys { get; set; }

        public DbSet<RegattaPlaner.Models.RegattaClub> RegattaClubs { get; set; }

        public DbSet<RegattaPlaner.Models.StartboatStandby> StartboatStandbys { get; set; }

        public DbSet<RegattaPlaner.Models.ClubCampingFee> ClubCampingFees { get; set; }

        public DbSet<RegattaPlaner.Models.RRFreeStartslots> RRFreeStartslots { get; set; }

        public DbSet<RegattaPlaner.Models.DeletedStartboats> DeletedStartboats { get; set; }

        public DbSet<RegattaPlaner.ViewModels.Mannschaftswertung> Mannschaftswertung { get; set; }
    }
}
